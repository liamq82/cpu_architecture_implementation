...
public class Process implements Comparable<Process> {
	...
	public Process(PriorityClass pClass, int runTime){
		this(pClass);
	...
	public String toString() {
		...
		str = (str + "(" + this.getLastRan() + ", " + getProcessRunTime() + ")");
		return str;
		
//		String runTime = getProcessRunTime();
//		return runTime;
	}
	...
	/*
	 * method cpu will call to decrement process runtime
	 * by 1ms
	 * */
	public void decrementProcessRunTime(){
